...
public class GameField extends GameObject{
    ...
    public static Position BRCorner = new Position(350,660);
    public static Position BLCorner = new Position(50,660);
    public static Position TRCorner = new Position(350,60);
    public static Position TLCorner = new Position(50,60);
    //Tile Sizes
